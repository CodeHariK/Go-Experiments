...
* [Deploy the same app to App Engine, Cloud Functions, and Cloud Run?](https://www.youtube.com/watch?v=eTotLOVR7MQ)
...
* [Picking the right serverless platform (Part 1)](https://www.youtube.com/watch?v=gle26fT28Bw)

* [Network-restricted functions](https://www.youtube.com/watch?v=YMJwR7--tUw)
...
* [How to build next-level web applications with Cloud Run](https://www.youtube.com/watch?v=SiFo7XZc534)
* [Run your React app on Google Cloud](https://www.youtube.com/watch?v=NMnKGHgw8aM)
* [Deploy container](https://www.youtube.com/watch?v=cw34KMPSt4k)
* [Cloud Run to VPC, simplified](https://www.youtube.com/watch?v=SJcQBJeMXqA)
...
* [Introducing Autopilot in Google Kubernetes Engine](https://www.youtube.com/watch?v=vXBZl753NyY)

## Cloud Run Jobs

* [Running jobs on serverless with Cloud Run jobs](https://www.youtube.com/watch?v=7ByPslu4ewA)

## Cloud Function

* https://codelabs.developers.google.com/codelabs/cloud-starting-cloudfunctions-v2#0

* [Simplify Cloud Run development with Visual Studio Code](https://www.youtube.com/watch?v=EtMIEtLQNa0)
* [Cloud Functions local debugging](https://www.youtube.com/watch?v=v6ll4UxS0Os)
* [Calling a private Cloud Function from a virtual machine](https://www.youtube.com/watch?v=IVOp5TL5cK4)
...
* [How to port stateful web apps to Cloud Run](https://www.youtube.com/watch?v=mgTI-paDNQ4)

## Cloud SQL

* [Optimize application performance with Cloud Run and Cloud SQL](https://www.youtube.com/watch?v=r9qvB-JH4jM)
* [Cloud Run + Cloud SQL, setup](https://www.youtube.com/watch?v=cBrn5IM4mA8)
...
* [Gcloud command-line tips and tricks](https://www.youtube.com/watch?v=ezzZ--xt43c)
...
* [Data Streaming with Pub/Sub and Dataflow: Best Practices](https://www.youtube.com/watch?v=6_7nBReSpNM)

## Data Pipeline

* [Developing a Data Pipeline on Google Cloud](https://www.youtube.com/watch?v=zpzKmzgj3dk)

## Dataplex

* [What’s new in data governance](https://www.youtube.com/watch?v=zvCdrNJsxBo)
* [Manage and govern distributed data with Dataplex](https://www.youtube.com/watch?v=a6QVNAlAAl0)
* [Build a Data Mesh on GCP with Dataplex](https://www.youtube.com/watch?v=j2hU_vkiWa0)
* [Govern your data at scale with Dataplex](https://www.youtube.com/watch?v=9OtbeRWBsLE)
...
* (Manage your Cloud Run secrets securely with Secret Manager)[https://www.youtube.com/watch?v=JIE89dneaGo]

## Eventarc

* [Event-driven applications with Eventarc and Cloud Run](https://www.youtube.com/watch?v=za82mvjur5E)
* https://cloud.google.com/eventarc/docs/samples
* https://github.com/GoogleCloudPlatform/eventarc-samples
* [Eventarc for Cloud Run](https://www.cloudskillsboost.google/focuses/15657?parent=catalog)
* [Trigger Cloud Run with Eventarc events](https://codelabs.developers.google.com/codelabs/cloud-run-events)

## Auth

* [Securing a REST API with JWT, code](https://www.youtube.com/watch?v=4HAbnin3nto)
...
* [Authenticate applications to Google Cloud](https://www.youtube.com/watch?v=PAOb2hl__08)

## IAP

* [Centralize access to your organization’s websites with Identity Aware Proxy (IAP)](https://www.youtube.com/watch?v=xM9-FSU5MoY)

## Workflow

* [Choreography vs Orchestration in microservices](https://www.youtube.com/watch?v=nJnrkcA7ZdA)
...
* [Cost optimization best practices for Google Cloud Storage](https://www.youtube.com/watch?v=c2wmPNzDz6U)
